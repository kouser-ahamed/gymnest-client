      ...
      <div className="mx-auto max-w-7xl space-y-6">
            ...
            >
              ...
              <div className="relative z-10 animate-pulse space-y-5">
                <div className="flex items-center gap-4">
                  <div className="h-16 w-16 rounded-2xl border-2 border-pink-200 bg-gradient-to-br from-fuchsia-100 via-pink-100 to-orange-100 dark:border-pink-500/40 dark:from-fuchsia-500/20 dark:via-pink-500/20 dark:to-orange-400/20" />
        ...
        <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
          {Array.from({ length: 3 }).map((_, index) => (
            ...
            >
              <div className="h-48 animate-pulse bg-gradient-to-br from-fuchsia-100 via-pink-100 to-orange-100 dark:from-fuchsia-500/20 dark:via-pink-500/20 dark:to-orange-400/20" />
              ...
              <div className="space-y-4 p-5">
                ...
                <div className="h-16 animate-pulse rounded-2xl bg-gradient-to-br from-slate-100 via-pink-50 to-orange-50 dark:from-white/10 dark:via-pink-500/10 dark:to-orange-400/10" />

                <div className="h-11 animate-pulse rounded-full bg-gradient-to-r from-fuchsia-200 via-pink-200 to-orange-200 dark:from-fuchsia-500/20 dark:via-pink-500/20 dark:to-orange-400/20" />
              </div>
            </div>
          ))}
        </div>
