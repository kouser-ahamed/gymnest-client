  ...
  return (
    <div className="min-h-[calc(100vh-80px)] bg-gradient-to-br from-slate-50 via-pink-50/60 to-orange-50 px-4 py-8 dark:from-[#050914] dark:via-[#101624] dark:to-[#261425] sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl space-y-6">
            ...
            >
              <div className="flex animate-pulse items-center gap-4">
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <div className="h-4 w-36 rounded-full bg-gradient-to-r from-slate-200 via-pink-100 to-orange-100 dark:from-white/10 dark:via-pink-500/10 dark:to-orange-400/10" />
                </div>
              </div>
            </div>
          ))}
            ...
            >
              ...
              <div className="relative z-10 animate-pulse space-y-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="h-20 rounded-2xl bg-gradient-to-br from-fuchsia-50 via-pink-50 to-orange-50 dark:from-fuchsia-500/10 dark:via-pink-500/10 dark:to-orange-400/10" />

                  <div className="h-20 rounded-2xl bg-gradient-to-br from-orange-50 via-pink-50 to-fuchsia-50 dark:from-orange-400/10 dark:via-pink-500/10 dark:to-fuchsia-500/10" />
                </div>
        ...
        <div className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white/85 shadow-xl shadow-slate-900/5 backdrop-blur-xl dark:border-white/10 dark:bg-[#101624]/90">
          <div className="border-b border-slate-200 p-5 dark:border-white/10">
            <div className="animate-pulse space-y-3">
              <div className="h-6 w-48 rounded-full bg-gradient-to-r from-slate-200 via-pink-100 to-orange-100 dark:from-white/10 dark:via-pink-500/10 dark:to-orange-400/10" />

              <div className="h-4 w-72 max-w-full rounded-full bg-gradient-to-r from-slate-200 via-pink-100 to-orange-100 dark:from-white/10 dark:via-pink-500/10 dark:to-orange-400/10" />
            </div>
          </div>
          ...
          <div className="divide-y divide-slate-200 dark:divide-white/10">
            {Array.from({ length: 4 }).map((_, index) => (
              <div
                key={index}
                className="grid gap-4 p-5 lg:grid-cols-[2fr_1.5fr_1fr_1fr] lg:items-center"
              >
                <div className="flex animate-pulse items-center gap-4">
                  <div className="h-12 w-12 rounded-xl border-2 border-pink-200 bg-gradient-to-br from-fuchsia-100 via-pink-100 to-orange-100 dark:border-pink-500/40 dark:from-fuchsia-500/20 dark:via-pink-500/20 dark:to-orange-400/20" />

                  <div className="space-y-3">
                    <div className="h-4 w-36 rounded-full bg-gradient-to-r from-slate-200 via-pink-100 to-orange-100 dark:from-white/10 dark:via-pink-500/10 dark:to-orange-400/10" />

                    <div className="h-3 w-24 rounded-full bg-gradient-to-r from-slate-200 via-pink-100 to-orange-100 dark:from-white/10 dark:via-pink-500/10 dark:to-orange-400/10" />
                  </div>
                </div>

                <div className="h-4 w-48 max-w-full animate-pulse rounded-full bg-gradient-to-r from-slate-200 via-pink-100 to-orange-100 dark:from-white/10 dark:via-pink-500/10 dark:to-orange-400/10" />

                <div className="h-8 w-24 animate-pulse rounded-full bg-gradient-to-r from-fuchsia-100 via-pink-100 to-orange-100 dark:from-fuchsia-500/20 dark:via-pink-500/20 dark:to-orange-400/20" />

                <div className="h-9 w-28 animate-pulse rounded-full bg-gradient-to-r from-pink-100 to-orange-100 dark:from-pink-500/20 dark:to-orange-400/20" />
              </div>
            ))}
          </div>
        </div>
