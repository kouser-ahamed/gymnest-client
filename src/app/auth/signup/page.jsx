...
// 1. Loading Skeleton for the Suspense Boundary Fallback
...
// 2. Component Content utilizing `useSearchParams()` safely
...
// 3. Main Export Wrapping everything safely in Suspense
export default function SignupPage() {
  return (
